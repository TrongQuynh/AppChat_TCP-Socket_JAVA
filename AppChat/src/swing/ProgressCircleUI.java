...
public class ProgressCircleUI extends BasicProgressBarUI {
    ...
    public ProgressCircleUI(Progress pro) {
        this.pro = pro;
        imageDown = new ImageIcon(new File("src/Icons/down.png").getAbsolutePath()).getImage();
        imageCancel = new ImageIcon(new File("src/Icons/cancel.png").getAbsolutePath()).getImage();
        imageFile = new ImageIcon(new File("src/Icons/files.png").getAbsolutePath()).getImage();
    }
